...
public class SheduleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WebView shedule = (WebView) findViewById(R.id.shedule);
        shedule.loadUrl("http://jxzxehallapp.bit.edu.cn/jwapp/sys/wdkbbyMobile/*default/index.do#/");
        WebSettings webSettings = shedule.getSettings();//获得WebView的设置
        ...
        shedule.setWebViewClient(new WebViewClient(){
            @Override
