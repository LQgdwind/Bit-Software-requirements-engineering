...
public class ReservationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WebView reservation = (WebView) findViewById(R.id.reservation);
        reservation.loadUrl("http://stu.bit.edu.cn/xsfw/sys/swmcdyyapp/*default/index.do");
        WebSettings webSettings = reservation.getSettings();//获得WebView的设置
        ...
        reservation.setWebViewClient(new WebViewClient(){
            @Override
