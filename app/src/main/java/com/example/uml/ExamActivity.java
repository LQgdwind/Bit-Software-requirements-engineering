...
public class ExamActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exam.loadUrl("http://jxzxehallapp.bit.edu.cn/jwapp/sys/wdksapMobile/*default/index.do#/");
        WebSettings webSettings = exam.getSettings();//获得WebView的设置
        ...
        exam.setWebViewClient(new WebViewClient(){
            @Override
